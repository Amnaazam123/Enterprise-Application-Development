/*
 ~ class Activity - Maintain the count of list whenever you add any item in list as well as display data.
*/
...
namespace events2
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Count : " + e.count+" and its value is "+e.myData);
            };
            list.Add(12);
            list.Add(123);
            list.Add("AMNA");
